...
export const validationSchema = Yup.object({
  ...
  birthDate: Yup.date(),
  deliveryOptionCity: Yup.string()
    .min(2, 'Місто повинно містити не менше 2 символів')
    .max(50, 'Місто повинно містити не більше 50 символів'),
  deliveryOptionMethod: Yup.string().oneOf(['nova_poshta', 'ukrposhta', 'self_pickup', '']),
  deliveryOptionDepartment: Yup.string()
    .min(1, 'Відділення повинно містити не менше 1 символів')
    .max(50, 'Відділення повинно містити не більше 50 символів'),
});
